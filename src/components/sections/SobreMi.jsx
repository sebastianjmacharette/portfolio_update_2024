...
function SobreMi() {
  return (
    ...
    >
      <div className="divider divider-start px-2 divider-secondary ml-4 mr-6 text-2xl text-white">Sobre Mi</div>
        ...
        <div className="h-full lg:w-1/3">
          <div className="px-8 lg:pt-20 sm:pt-6 lg:pb-16 sm:pb-2 relative">
            ...
            <p className="sm:text-center lg:text-right mb-3">
              ...
              sido moldeada por una pasión inquebrantable por la tecnología
      ...
      <div className="divider divider-end px-2 divider-secondary ml-4 mr-6 text-2xl text-white">Sobre Mi</div>
    </motion.div>
  );
}
